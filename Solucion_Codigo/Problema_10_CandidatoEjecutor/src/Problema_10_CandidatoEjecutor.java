...
public class Problema_10_CandidatoEjecutor {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Ingrese el partido politico del candidato 1: ");
        ...
        System.out.print("Ingrese el numero de propuestas del candidato 1: ");
        candidato1.setNumeroPropuestas(sc.nextInt());

        sc.nextLine();

        Candidato candidato2 = new Candidato("Luis Torres", "Partido Renovacion Nacional");
...
class Candidato {
    ...
    public String toString() {
        return "CandidatoPresidencial{"
                ...
                + ", Numero de Propuestas Clave=" + numeroPropuestas
                + ", Cumple Edad Minima=" + (validarEdadMinima() ? "Si" : "No")
