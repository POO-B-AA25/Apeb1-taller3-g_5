...
public class Problema_05_EstudianteEjecutar {
    ...
    public static void main(String args[]) {
        ...
        estudiante2 = new Estudiante("Juan Pérez", 7.5, 8.0, 6.0);
...
class Estudiante {
    ...
    public String toString() {
        return "Estudiante:\n"
                ...
                + "Calificación Materia 1: " + calificacionMateria1 + "\n"
                + "Calificación Materia 2: " + calificacionMateria2 + "\n"
                + "Calificación Materia 3: " + calificacionMateria3 + "\n"
                + "Promedio: " + promedio + "\n"
                + "Estado: " + estado;
    }
}