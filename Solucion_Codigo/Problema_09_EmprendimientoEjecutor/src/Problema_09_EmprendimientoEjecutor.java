...
public class Problema_09_EmprendimientoEjecutor {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Ingrese el sector economico: ");
        ...
        System.out.print("Ingrese la fecha de inicio (anio): ");
        ...
        Emprendimiento emp2 = new Emprendimiento("Cafe Aroma", "1234567890001", "Alimentos", "Maria Perez", "Quito - La Mariscal", 2020, 30000);
...
class Emprendimiento {
    ...
    public String toString() {
        return "Emprendimiento{"
                ...
                + ", RUC='" + ruc + '\''
                + ", Sector Economico='" + sectorEconomico + '\''
                + ", Propietario='" + propietario + '\''
                + ", Ubicacion='" + ubicacion + '\''
                + ", Fecha de Inicio=" + fechaInicio
                + ", Capital Inicial=" + capitalInicial
                + ", Antiguedad=" + calcularAntiguedad() + " anios"
